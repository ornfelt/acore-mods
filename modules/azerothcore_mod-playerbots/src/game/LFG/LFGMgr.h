...
typedef std::unordered_multimap<uint32 /*dungeonId*/, LFGReward /*reward*/> LFGRewardMap;
typedef std::pair<LFGRewardMap::const_iterator, LFGRewardMap::const_iterator> LFGRewardMapBounds;
typedef std::unordered_map<ObjectGuid /*group or player guid*/, LFGQueueInfo> LFGQueueInfoMap;
typedef std::unordered_map<uint32/*dungeonID*/, LFGDungeonEntry const*> LFGDungeonMap;
typedef std::unordered_map<uint32/*ID*/, LFGProposal> LFGProposalMap;

typedef std::unordered_map<LFGDungeonEntry const*, LFGQueueStatus> LFGQueueStatusMap;
typedef std::unordered_map<ObjectGuid, LFGRoleMask>  LFGRolesMap;
typedef std::unordered_set<LFGQueueInfo*> LFGQueue;
typedef std::unordered_map<LFGDungeonEntry const*, GuidSet> LFGSearchMap;
typedef std::list<LFGEvent> LFGEventList;

typedef std::unordered_map<ObjectGuid /*group or player guid*/, LFGStateStructure*> LFGStatesMap;
