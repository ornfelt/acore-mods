...
enum ContinentArea
{
    ...
    MAP571_DALARAN = 31, // Dalaran, part of Crystalsong Forest
    MAP571_NORTH = 32, // Icecrown, Storm Peaks
    MAP571_SOUTH = 33, // Borean Tundra, Sholazar Basin, Wintergrasp, Dragonblight, Grizzly Hills, Howling Fjord, rest of Crystalsong Forest
